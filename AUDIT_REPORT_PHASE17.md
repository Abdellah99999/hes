...
> [!NOTE]
> **Décision Stratégique — Phase 16 (Pivot Web Responsive / PWA) :**
> Conformément au pivot d'architecture, les applications mobiles natives Flutter (`mobile/client/` et `mobile/courier/`) sont abandonnées. Le frontend web unique (`frontend/`) devient une PWA responsive assurant l'expérience dédiée pour les rôles livreur et client sur mobile/tablette.
...
4. **Phase 16 - Pivot acté :** Les dossiers mobiles natifs sont supprimés ; le développement se concentre sur l'adaptation web responsive et PWA du frontend unique pour les livreurs et clients.

> **Statut : CŒUR APPLICATIF (PHASES 1-15) VALIDÉ. STABILISATION RÉALISÉE. PIVOT PHASE 16 (PWA RESPONSIVE) ENCLENCHÉ.**
